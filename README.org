...
- *Actions* — Resource-specific actions (port-forward, rollout, top, terminals) pulled from both upstream kubed suffixes and kubed-ext additions
- *General* — Refresh, describe, filter, label selector, quit
- *Utilities* — Switch buffer, copy name, copy menu, command log
...
- [[https://k9scli.io/][k9s]] — Inspiration for UX and feature design
